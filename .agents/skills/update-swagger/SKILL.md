---
name: update-swagger
description: Update and regenerate backend Swagger/OpenAPI documentation when routes, controllers, validators, models, request shapes, response shapes, or authentication behavior change, or when the user asks to refresh Swagger.
---
